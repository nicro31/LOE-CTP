...
struct Graph
{
    ...
    void gdm(double sigma, double mu, unsigned int seed);
    ...
    void writeTransferDistanceAngle(std::string fileName, int l1, int l2); // Write 3d points (distance, angleN, transfer), for transfer from level1 to level2
