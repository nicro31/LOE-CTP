...
void computeMobilityDependance(Graph &g, std::vector<double> pField, std::vector<double> pTemperature, std::vector<double> pConcentration, std::string folder, RateType rate); // Compute the mobility for different values of the parameters field, tempearture and concentration
...
Graph initCoarseGraph(std::string fileNameCoord, std::string configFile); // Init graph from coarse grained MD
